...
class DelayedSizeAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  DelayedSizeAnimationState createState() => DelayedSizeAnimationState();
}

class DelayedSizeAnimationState extends State<DelayedSizeAnimation>
